...
#Image des pièces
image=pygame.image.load("triple_town/pierre.png").convert_alpha()
image2=pygame.image.load("triple_town/rocher.png").convert_alpha()
image3=pygame.image.load("triple_town/tour.png").convert_alpha()
image4=pygame.image.load("triple_town/manoir.png").convert_alpha()
image5=pygame.image.load("triple_town/herbe.png").convert_alpha()
image6=pygame.image.load("triple_town/buisson.png").convert_alpha()
image7=pygame.image.load("triple_town/arbuste.png").convert_alpha()
image8=pygame.image.load("triple_town/niche.png").convert_alpha()
image9=pygame.image.load("triple_town/maison.png").convert_alpha()
image10=pygame.image.load("triple_town/villa.png").convert_alpha()
image11=pygame.image.load("triple_town/chateau.png").convert_alpha()
image12=pygame.image.load("triple_town/chateaumagique.png").convert_alpha()
